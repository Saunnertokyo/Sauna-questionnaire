...
```{r}
## recode variable
X20211026_processed <- mutate(X20211026_processed, Segment_rc = car::Recode(Segment, "1='Beauty';2='Otsukiai';3='Business person';4='Sadou seeker';5='Body recovery';6='Perfect mankitsu'"))
```
